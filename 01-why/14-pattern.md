...
주식이나 코인 거래에는 여러 스타일이 있습니다.

| 스타일 | 보유 기간 | 특징 |
|--------|----------|------|
| 장기투자 | 수개월~수년 | 기업 가치 분석, 느긋한 대응 |
| 스윙 | 며칠~수주 | 추세 따라 매매, 주기적 점검 |
| 초단타 | 수초~수분 | 순간 가격차 포착, 자동화 필수 |

이 트레이더는 **초단타(고빈도 트레이딩)**를 합니다. 하루에 수천 건씩 거래하는 방식이죠. 사람이 직접 하기엔 불가능한 속도입니다. 그래서 AI 시스템이 필수입니다.
