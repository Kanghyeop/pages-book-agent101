...
![툴의 역할](/pages-book-agent101/assets/tool-extension.svg)
...
![연결 방식 비교](/pages-book-agent101/assets/connection-types.svg)
...
![MCP 동작 흐름](/pages-book-agent101/assets/mcp-flow.svg)
...
![에이전트 인프라](/pages-book-agent101/assets/lumia-infra.svg)
